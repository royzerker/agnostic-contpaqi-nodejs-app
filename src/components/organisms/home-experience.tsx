...
export default function HomeExperience() {
	return (
		<section className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-10 md:grid-cols-2 md:px-0 md:py-20">
			<figure className="h-auto max-h-[300px] w-full overflow-hidden rounded-3xl">
				<Image src={imageUrl} alt="Imagen de ejemplo" width={400} height={400} className="h-full w-full rounded-3xl object-cover object-center" />
			</figure>
			...
			<section className="space-y-4">
				...
				<footer className="inline-block">
					<Link href="/red-social" className={cn(buttonVariants({ size: 'lg' }), 'pointer-events-none bg-foreground/50 text-base')}>
						Videos Feed
					</Link>
				</footer>
			</section>
